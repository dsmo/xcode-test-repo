...
#import "GNMasterViewController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    GNMasterViewController *controller = (GNMasterViewController *)navigationController.topViewController;
    ...
    [failedBankDetails setValue:@123456 forKey:@"zip"];
